                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="{{ route('barangkeluar.insert') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">Tanggal Keluar</label>
                                        <input type="text" id="date-format" class="form-control" name="tanggal_keluar" required>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="jumlahkeluar" name="jumlah" onkeyup="sum()" required>
                                    </div>
